...
class ProductScreenExample10 extends StatefulWidget {
  const ProductScreenExample10();

  @override
  State<ProductScreenExample10> createState() => _ProductScreenExample9State();
}

class _ProductScreenExample9State extends State<ProductScreenExample10> {
  late int count;
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              NavigationManager10.instance.pop(count);
            },
          ),
        ],
      ),
