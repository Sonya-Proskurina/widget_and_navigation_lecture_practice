...
class StoreScreenExample6 extends StatefulWidget {
  const StoreScreenExample6({super.key});

  @override
  State<StoreScreenExample6> createState() => _StoreScreenExample6State();
}

class _StoreScreenExample6State extends State<StoreScreenExample6> {
