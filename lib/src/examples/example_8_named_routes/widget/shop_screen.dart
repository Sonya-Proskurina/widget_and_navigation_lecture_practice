...
class StoreScreenExample8 extends StatefulWidget {
  const StoreScreenExample8({super.key});

  @override
  State<StoreScreenExample8> createState() => _StoreScreenExample8State();
}

class _StoreScreenExample8State extends State<StoreScreenExample8> {
