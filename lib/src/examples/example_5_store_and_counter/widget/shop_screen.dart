...
class StoreScreenExample5Counter extends StatefulWidget {
  const StoreScreenExample5Counter({super.key});

  @override
  State<StoreScreenExample5Counter> createState() => _StoreScreenExample5CounterState();
}

class _StoreScreenExample5CounterState extends State<StoreScreenExample5Counter> {
